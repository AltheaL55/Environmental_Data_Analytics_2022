...
NTL.phys.data.Tuesday.1990to1999.July <- filter(NTL.phys.data.Tuesday.1990to1999, month(sampledate)==7)
...
NTL.phys.data.Tuesday.90s.07 <- 
  NTL.phys.data.Tuesday.1990to1999.July %>%
  filter(depth == 0 ) %>%
